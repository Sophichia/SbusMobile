 ...
 */
public class StopsOverlay extends DataRequestListener.MapOverlay {
    ...
    public StopsOverlay(MainActivity context, DataRequestListener.MapClickListener listener, Type type) {
        super();
        mContext = context;
        mListener = listener;
        mHidden = false;
        ...
        mOverlay = new ItemizedIconOverlay<>(
                ...
                new ItemizedIconOverlay.OnItemGestureListener<OverlayItem>() {
                    ...
                    public boolean onItemLongPress(int i, OverlayItem myOverlayItem) {
                        return handleStopLongPress((StopOverlayItem) myOverlayItem);
                    }
                }, resourceProxy);
    }
    ...
    private boolean handleStopLongPress(StopOverlayItem item){
        Stop s = item.stop;
        mListener.onStopLongPress(s);
        return true;
    }
