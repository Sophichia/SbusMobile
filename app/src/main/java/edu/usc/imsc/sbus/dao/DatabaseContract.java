...
public final class DatabaseContract {
    ...
    // Inner class that store the watched buses
    public static abstract  class DataHalt implements BaseColumns{
        public static final String TABLE_NAME = "halt";
        public static final String COLUMN_NAME_STOP_ID = "stopId";
        public static final String COLUMN_NAME_STOP_NAME = "stopName";
        public static final String COLUMN_NAME_ROUTE = "route";
        public static final String COLUMN_NAME__TIME = "time";
    }
    ...
    public static final String SQL_CREATE_HALT_ENTRIES =
            "CREATE TABLE " + DataHalt.TABLE_NAME + " (" +
                    DataHalt.COLUMN_NAME_STOP_ID + TEXT_TYPE + COMMA_SEP +
                    DataHalt.COLUMN_NAME_STOP_NAME + TEXT_TYPE + COMMA_SEP+
                    DataHalt.COLUMN_NAME_ROUTE + TEXT_TYPE +COMMA_SEP +
                    DataHalt.COLUMN_NAME__TIME + TEXT_TYPE +
                    ")";
    ...
    public static final String SQL_DELETE_HALT_ENTRIES =
            "DROP TABLE IF EXISTS " + DataHalt.TABLE_NAME;
